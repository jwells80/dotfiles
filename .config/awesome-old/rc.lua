...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "c", function () awful.util.spawn( "teams-for-linux" ) end,
        {description = "run Teams", group = "Apps"}),
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( "/opt/microsoft/msedge/microsoft-edge --profile-directory=Default --app-id=faolnafnngnfdaknnbpnkhgohbobgegn --app-url=https://outlook.office.com/mail/ %U" ) end,
        {description = "Outlook Web (email)", group = "Apps"}),
    ...
    awful.key({ modkey }, "p", function () awful.util.spawn( "pycharm" ) end,
        {description = "PyCharm Python IDE", group = "Apps"}),
    ...
    awful.key({ }, "Print", function () awful.util.spawn("flameshot gui --path /home/jason/Pictures/Screenshots") end,
        {description = "Screenshot(Flameshot)", group = "screenshots"}),
 ...
 -- Show/Hide Systray
    ...
    -- Calculator button
    awful.key({ }, "XF86Calculator", function () awful.spawn("tdrop -ma -w 324 -h 222 -x 40% -y 35% gnome-calculator") end),
